...
import org.hengdao.transaction.TransactionInterceptorExtra;
...
public class MultiDataSourceTransactionManager extends AbstractPlatformTransactionManager implements
    ...
    private Class<?> newAdviceClass = TransactionInterceptorExtra.class;
    ...
    protected void doBegin(Object transaction, TransactionDefinition definition) {
        ...
        try {
            ...
            Reflections.invokeMethod(txObject.getConnectionHolder(), "setTransactionActive",
